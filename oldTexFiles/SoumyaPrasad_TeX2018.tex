...
\section{Experience}
\cventry{May, '19 - Nov, '20}{QA Engineer}{\href{https://www.cabonline.com}{\textsc{\color{cyan}Cabonline}}}{Stockholm}{}{
\begin{itemize}
\item Write end-to-end tests for various web products
\item Write visual regression tests- both component and integration level to enable maximum UI coverage 
...
\item Cypress, ReactJs, Docker, Jenkins, Docker Jenkins plugin, Loki, e2e testing
\end{itemize}
}
